...
var clientHints = function clientHints(mode) {
  ...
  if (!((_navigator2 = navigator) !== null && _navigator2 !== void 0 && (_navigator2$userAgent = _navigator2.userAgentData) !== null && _navigator2$userAgent !== void 0 && _navigator2$userAgent.getHighEntropyValues)) return new Promise(function (resolve) {
    resolve(null);
  });
  return navigator.userAgentData.getHighEntropyValues(['platform', 'platformVersion', 'architecture', 'model', 'uaFullVersion', 'bitness', 'fullVersionList', 'wow64']).then(function (d) {
    var _navigator3, _navigator3$userAgent, _navigator4, _navigator4$userAgent, _navigator5, _navigator5$userAgent;
    return {
      _user_agent_architecture: d.architecture,
      _user_agent_bitness: d.bitness,
      _user_agent_full_version_list: encodeURIComponent((d.fullVersionList && Object.values(d.fullVersionList) || ((_navigator3 = navigator) === null || _navigator3 === void 0 ? void 0 : (_navigator3$userAgent = _navigator3.userAgentData) === null || _navigator3$userAgent === void 0 ? void 0 : _navigator3$userAgent.brands)).map(function (h) {
        return [h.brand, h.version].join(';');
      }).join('|')),
      _user_agent_mobile: d.mobile ? 1 : 0,
      _user_agent_model: d.model || ((_navigator4 = navigator) === null || _navigator4 === void 0 ? void 0 : (_navigator4$userAgent = _navigator4.userAgentData) === null || _navigator4$userAgent === void 0 ? void 0 : _navigator4$userAgent.mobile),
      _user_agent_platform: d.platform || ((_navigator5 = navigator) === null || _navigator5 === void 0 ? void 0 : (_navigator5$userAgent = _navigator5.userAgentData) === null || _navigator5$userAgent === void 0 ? void 0 : _navigator5$userAgent.platform),
...
var ga4mp = function ga4mp(measurement_ids) {
  ...
  var internalModel = Object.assign({
    version: version,
    debug: false,
  ...
  if (internalModel.mode === 'browser') {
    ...
    if (pageData) {
      internalModel.payloadData = Object.assign(internalModel.payloadData, pageData);
    }
  }
  /**
   * Dispatching Queue
  ...
  var buildPayload = function buildPayload(eventName, customEventParameters) {
    ...
    var eventParameters = Object.assign(JSON.parse(JSON.stringify(internalModel.persistentEventParameters)), JSON.parse(JSON.stringify(customEventParameters)));
  ...
  var trackEvent = function trackEvent(eventName) {
    ...
    var sessionControl = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    clientHints(internalModel === null || internalModel === void 0 ? void 0 : internalModel.mode).then(function (ch) {
      if (ch) {
        internalModel.payloadData = Object.assign(internalModel.payloadData, ch);
      }
